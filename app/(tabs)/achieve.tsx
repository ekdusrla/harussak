    		...
    		<View style={[styles.safeareaview, styles.viewFlexBox]}>
              ...
              <View style={{ flexDirection: "row", justifyContent: "center", marginTop: 0 }}>
                <TouchableOpacity onPress={() => setActiveTab("achieve")} style={{ position: "absolute", left: 64, top: 140, zIndex: 10 }}>
                  <Text style={[{ fontSize: 20, fontWeight: "600", color: "#9ea4a9", fontFamily:"NanumSquareNeo-Rg" }, activeTab === "achieve" && { color: "#464b53" }]}>
                    업적 도감
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => setActiveTab("plant")} style={{ position: "absolute", right:72, top: 140, zIndex: 10 }}>
                  <Text style={[{ fontSize: 20, fontWeight: "600", color: "#9ea4a9", fontFamily:"NanumSquareNeo-Rg" }, activeTab === "plant" && { color: "#464b53" }]}>
                    식물 도감
                  </Text>
                </TouchableOpacity>
              </View>
