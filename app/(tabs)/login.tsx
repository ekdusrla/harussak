...
export default function Login() {
    ...
    return (
        <View style={{flex : 1, justifyContent : "center", alignItems : "center"}}>
            <Text style={{fontSize:20}}> default pretendard nanumsqureneo</Text>
            <Text style ={{fontFamily :"Pretendard-Regular", fontSize: 20}}> default pretendard nanumsqureneo </Text>
            <Text style ={{fontFamily :"NanumSquareNeo-Rg", fontSize: 20}}> default pretendard nanumsqureneo </Text>  
        </View>
    );
}
